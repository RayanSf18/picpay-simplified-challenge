package br.com.rayan.backend.picpaysimplificado.infra;

import br.com.rayan.backend.picpaysimplificado.dtos.ExceptionDTO;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity threatDuplicateEntry(Exception ex) {
